...
{/*
        ...
        <div className='mt-5'>
          <p className='text-base font-medium text-muted text-opacity-60'>
            <b>SiDi | Sistem Digitalisasi</b> adalah merek yang berfokus pada pembuatan dan perancangan berbagai produk digital untuk mendukung kebutuhan administrasi, informasi, dan kreativitas di era modern.
          </p><br/>
          <p className='text-base font-medium text-muted text-opacity-60'>
            Kami menyediakan tiga kategori utama produk:
            <li><b>Aplikasi Web</b> – mencakup layanan media sosial, kolaborasi, hiburan, keuangan, pendidikan, hingga layanan informasi yang dirancang untuk mempermudah aktivitas digital Anda.</li>
            <li><b>Dokumen Digital</b> – berbagai template dokumen profesional dalam format DOCX, PDF, TXT, XLSX, presentasi, formulir, dan lainnya, siap digunakan untuk kebutuhan kerja maupun personal.</li>
            <li><b>Desain Digital</b> – koleksi template infografis, animasi dan video, ilustrasi digital, hingga desain spanduk/poster yang memadukan estetika dan fungsi.</li>
          </p><br/>
          <p className='text-base font-medium text-muted text-opacity-60'>
            Didirikan oleh <b>Maru Pian</b> sebagai usaha perorangan, seluruh produk yang hadir di SiDi adalah hasil karya orisinal yang dirancang dengan detail dan dedikasi tinggi.
            Dengan visi menjadi solusi utama dalam digitalisasi administrasi dan informasi, kami berkomitmen memberikan produk yang praktis, berkualitas, dan siap pakai.
          </p>
        </div>
      </div>
